...
| Path | Purpose |
|------|---------|
| `CLAUDE-TEMPLATE.md` | System config source — personalized during setup → becomes user's `CLAUDE.md` |
...
|----------|-------------------|--------------|
| `CLAUDE-TEMPLATE.md` | High | Tool ecosystem, skills table, interaction depth, root path |
