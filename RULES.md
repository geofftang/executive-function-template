...
<!-- SETUP-ONLY: This comment triggers initial setup. Read execution/reference/setup/SETUP-GUIDE.md and begin Phase 1. Remove this comment when setup is complete. @update-system: ignore this line — it is not present in active systems. -->
